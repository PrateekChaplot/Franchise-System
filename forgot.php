...
<!-- banner -->
  <div class="courses_banner">
	...
	<div class="courses_box1">
	   <div class="container">
	   	  <form class="login" action="includes/forgot-inc.php" method="POST">
	    	  <p class="lead">Enter your e-mail!</p>
  		    <div class="form-group">
  			    <input autocomplete="off" type="text" name="email" class="required form-control" placeholder="E-mail">
  		    </div>
          <!--  -->
  		    <!-- <div class="form-group">
            ...
            <!--  -->
  				<button type="submit" name="submit" class="btn btn-primary btn-lg1 btn-block">Reset password</button>
  		    </div>
